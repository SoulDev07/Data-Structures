...
// Gets the Middle right Node
Node *getMidRightNode(Node *head)
{
    Node *slow = head, *fast = head;
...
void sort(Node *head)
{
    ...
    do
    {
        ...
        // Move the tail to the last swapped node
        tail = curr;
